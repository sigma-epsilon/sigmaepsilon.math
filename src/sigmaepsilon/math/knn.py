...
import scipy as sp
from scipy.spatial import KDTree as KD_scipy
from packaging import version
import warnings

try:  # pragma: no cover
    from sklearn.neighbors import KDTree as KD_sklearn
...
def k_nearest_neighbours(
    ...
    *,
    ...
    if backend == "scipy":
        tree = KD_scipy(X, leafsize=leaf_size, **tree_kwargs)
        ...
        tree = KD_sklearn(X, leaf_size=leaf_size, **tree_kwargs)
